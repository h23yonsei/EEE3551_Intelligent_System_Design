        ...
        begin
            ...
            for(j=0; j<FIFO_DEPTH; j=j+1) begin
                ...
                if({mem_to_DUT[2*FIFO_DEPTH+j], mem_to_DUT[FIFO_DEPTH+j], mem_to_DUT[j]} != data_out) begin
                    ...
                    $writememh("C:/Xilinx/Vivado/IntelligentSystemDesign/Assignment3/assignment3_top/mem_to_DUT.hex", mem_to_DUT);
                    $writememh("C:/Xilinx/Vivado/IntelligentSystemDesign/Assignment3/assignment3_top/mem_from_DUT.hex", mem_from_DUT);
                    //$finish();
                end
            end
